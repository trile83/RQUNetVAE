...
class DownConv(nn.Module):
    ...
    """
    def __init__(self, in_channels, out_channels, pooling=True, dropout=False, shrink=False):
...
class UNet_VAE_RQ_old_trainable(nn.Module):
    def __init__(self, num_classes, in_channels=3, depth=5, 
        ...
        for i in range(depth):
            ...
            down_conv = DownConv(ins, outs, pooling=pooling, dropout=dropout, shrink=shrink)
