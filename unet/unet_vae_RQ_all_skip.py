...
class RieszQuincunx(nn.Module):
    ...
    def __init__(self, alpha, height, width):
        super().__init__()
...
class DownConv(nn.Module):
    ...
    """
    def __init__(self, in_channels, out_channels, alpha, im_height, im_width, pooling=True, dropout=False, shrink = False):
        ...
        if self.shrink:
            ...
            self.s_shrink = RieszQuincunx(alpha, im_height, im_width)
    ...
    def __init__(self, num_classes, alpha=0.0, in_channels=3, depth=5, 
        ...
        for i in range(depth):
            ...
            if i == 0:
                ...
                im_height, im_width = 32, 32

            down_conv = DownConv(ins, outs, self.alpha, im_height, im_width, pooling=pooling, dropout=dropout, shrink=shrink)
