    ...
    for epoch in range(epochs):
        ...
        with tqdm(total=n_train, desc=f'Epoch {epoch + 1}/{epochs}', unit='img') as pbar:
            ...
            if min_valid_loss > valid_loss:
                ...
                torch.save(net.state_dict(), str(dir_checkpoint / 'checkpoint_{model}_epoch{number}_senegal_7-6_recon.pth'.format(model=unet_option, number=epoch + 1, alpha=alpha)))
