...
if __name__ == '__main__':
    ...
    unet_vae_rq_dict_file = '/home/geoint/tri/github_files/unet_vae_RQ_dictionary_4-5.pickle'
    ...
    plt.plot(sigma_range, sigma_acc_unet_rq, label = 'Unet RQ 0.5')
    plt.fill_between(sigma_range, sigma_acc_unet_rq-std_unet_rq, sigma_acc_unet_rq+std_unet_rq, alpha=0.5)
    #plt.plot(sigma_range, sigma_acc_unet_vae_rq_1, label = 'Unet VAE RQ 0.1')
